...
The tracked `data/v2/` directory is a compact integration/starter snapshot and should not be treated as a canonical archival copy of any upstream database. GitHub Actions rebuilds the uncapped public snapshot from source downloads at deployment time.
